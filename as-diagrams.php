...
{ // bar diagram class
  ...
  var $drawempty_x = 0; // if 0, don't draw zero columns
  var $drawempty_y = 0; // if 0, don't draw zero bars and "rows" in digit part

  function HideEmptyXY($val=true) 
  {
    $this->drawempty_x = $this->drawempty_y = !$val;
  }
  function HideEmptyY($val=true) 
  { 
	$this->drawempty_y = !($val); 
  }
